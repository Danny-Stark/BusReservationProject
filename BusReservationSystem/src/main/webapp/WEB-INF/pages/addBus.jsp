...
<body>
	<div class="container">
		...
		<form method="post" action="addBus.do">
			...
			Arrive Date <input type="date" name="arriveDate" /> <br>
			Arrival Time <input type="time" name="arriveTime" /> <br>
						...
						<div class="card-body ">
							<form  method="post" action="addBus.do">
								...
								<div class="form-outline mb-2">
									<input type="text" name="busName" id="form3Example3" class="form-control"
										 /> <label
										class="form-label"  for="form3Example3">Bus Name</label>
								</div>
								<!-- Password input -->
								<div class="form-outline mb-2">
									<input type="text"  name="source" id="form3Example4" class="form-control"
									 /> <label class="form-label"
										for="form3Example4">Source</label>
								</div>
								<div class="form-outline mb-2">
									<input type="text"  name="destination" id="form3Example4" class="form-control"
									/> <label class="form-label"
										for="form3Example4">Destination</label>
								</div>

								<div class="form-outline mb-2">
									<input type="date"  name="deparDate"  id="form3Example4" class="form-control"
										 /> <label class="form-label"
										for="form3Example4">Departure Date</label>
								</div>
								<div class="form-outline mb-2">
									<input type="time" name="departTime" id="form3Example4" class="form-control"
									 /> <label class="form-label"
										for="form3Example4">Departure Time</label>
								</div>
								<div class="form-outline mb-2">
									<input type="date" name="arriveDate" id="form3Example4" class="form-control"
										 /> <label class="form-label"
										for="form3Example4">Arrival Date</label>
								</div>

								<div class="form-outline mb-2">
									<input type="time" name="arriveTime" id="form3Example4" class="form-control"
										 /> <label class="form-label"
										for="form3Example4">Arrival Time</label>
								</div>
								<!-- <div class="form-outline mb-2">
									<input type="text" name="isBooked" id="form3Example4" class="form-control"
									 /> <label class="form-label"
										for="form3Example4">Is Booked</label>
								</div> -->
								<!-- Submit button -->
