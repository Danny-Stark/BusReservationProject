	...
	backdrop-filter: saturate(200%) blur(25px);
			...
			<div class="col-sm-4 ">
				<div class="card ">
					<div class="card-body">
						...
						<a href="searchBusBySourceAndDest.view" class="btn btn-primary">Click
							Here To Search Ticket</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						...
						<p class="card-text">With supporting text below as a natural
							lead-in to additional content.</p>
						<a href="addBusForm.view" class="btn btn-primary">Click Here
							To Show Bookings</a>
					</div>
				</div>
			</div>
		...
		<div class="row pt-5 pb-5 px-5">
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Access Profile</h5>
						<p class="card-text">With supporting text below as a natural
							lead-in to additional content.</p>
						<a href="viewCustomer.view" class="btn btn-primary">click here
							to Visit</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						...
						<p class="card-text">With supporting text below as a natural
							lead-in to additional content.</p>
						<a href="addPersonForm.view" class="btn btn-primary">click
							here to Update</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">View Ticket Details</h5>
						<p class="card-text">With supporting text below as a natural
							lead-in to additional content.</p>
						<a href="addPersonForm.view" class="btn btn-primary">click
							here to view</a>
